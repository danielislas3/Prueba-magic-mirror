   ...
   <div>
    ...
    <Row gutter={16} align="middle">
      <Descriptions
        ...
        <Badge status="processing" text={character.status} /></Descriptions.Item>
        <Descriptions.Item label="Specie">{character.species}
        </Descriptions.Item>
        <Descriptions.Item label="Type">{character.type?character.type:'unknow'}</Descriptions.Item>
